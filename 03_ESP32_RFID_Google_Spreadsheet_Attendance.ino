...
const char* ssid = "POGO";  //--> Your wifi name
const char* password = "Update2024"; //--> Your wifi password
//----------------------------------------

// Google script Web_App_URL.
String Web_App_URL = "https://script.google.com/macros/s/AKfycbwunz5ChWzsXHY4SkI01DPGqi899vUuS94GMIeHMSVOjEc7mYidilW5NFdpY8JgH-cefA/exec";
